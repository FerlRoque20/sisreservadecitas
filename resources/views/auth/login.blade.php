...
<head>
  ...
  <title>Sistema de reserva de citas ADS MOTORS</title>
  ...
  <script data-cfasync="false" nonce="ef1479ff-13a6-4a7d-99f5-dfd24f76ceaa">
    try {
      (function(w,d) {
        !function(j,k,l,m) {
          if (j.zaraz) console.error("zaraz is loaded twice");
            ...
            j.zaraz._v = "5838";
            j.zaraz._n = "ef1479ff-13a6-4a7d-99f5-dfd24f76ceaa";
            j.zaraz.q = [];
            ...
            j.zaraz.init = () => {
              ...
              if (j.dataLayer)
                for (const t of Object.entries(Object.entries(dataLayer).reduce(((u, v) => ({...u[1], ...v[1]})), {})))
        ...
        window.zaraz._p = async bs => new Promise((bt => {
          if (bs) {
            bs.e && bs.e.forEach((bu => {
              try {
                const bv = d.querySelector("script[nonce]"), bw = bv?.nonce || bv?.getAttribute("nonce"), bx = d.createElement("script");
                bw && (bx.nonce = bw);
                bx.innerHTML = bu;
                bx.onload = () => {
...
<body class="hold-transition login-page"
  style="background-image: url('{{url('assets/img/Portada.png')}}');
  ...
  <div class="login-box">
    ...
    <div class="card card-outline card-primary">
      <div class="card-header text-center">
        <a href="" class="h1"><b>ADS Agenda</b>PRO </a>
      </div>
      <div class="card-body">
