...
@section('content')
    <div class = "row">
        <h1>REGISTRO DE UN NUEVO ENCARGADO</h1>
    </div>
                ...
                <div class="card-body">
                    <form action="{{ url('/admin/encargados/create') }}" class="needs-validation" novalidate method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="">Nro de Celular</label> <b>*</b>
                                    ...
                                    <div class="invalid-feedback">Error: Ingrese su Nro de Telefono. Por favor, revisa e inténtalo nuevamente.</div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="invalid-feedback">Error: Ingrese la especialidad del Encargado. Por favor, revisa e inténtalo nuevamente.</div>
                                </div>
                            </div>
                        </div>
